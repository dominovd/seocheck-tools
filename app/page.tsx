...
const faqs = [
  {
    ...
    a: "Yes — all 19 tools are free to use without an account. AI-powered tools have a daily per-IP fair-use limit (15/day for most, 3-5/day for the YouTube-API-heavy analyzers and audits) to keep the compute affordable. Browser-side tools (Thumbnail Preview, Title Score Checker, etc.) have no limit.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. The current 19 tools cover the YouTube creator workflow — most recently the Channel Audit, Outlier Finder, and Thumbnail Preview. Multi-platform expansion (TikTok, Instagram, Pinterest) is planned. You can request a tool via the contact page.",
  },
];
